...
def train():
    ...
    num_train_streaks = 0
    print (STATE_BOUNDS[3][0], STATE_BOUNDS[3][1])
...
# Map raw observed state([cart position, cart velocity, pole angle, pole tip velocity])to corresponding bins of each state parameter as 1 state 
