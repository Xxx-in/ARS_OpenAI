...
def train():
    ...
    for episode in range(NUM_TRAIN_EPISODES):
        ...
        print('episode explore rate & training rate: ', explore_rate, learning_rate)
...
# Map raw observed state([cart position, cart velocity, pole angle, pole tip velocity])
# to corresponding bins of each state parameter as 1 state 
