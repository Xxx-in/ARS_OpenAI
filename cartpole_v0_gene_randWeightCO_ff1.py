        ...
        for y in range(NUM_BUCKETS[3]):
            for z in range(NUM_ACTIONS): 
                if (random.random() <= 0.95):    # determine if crossover happens
                    ...
                    child1_q_table[0][0][x][y][z] = random1 * parent1_q_table[0][0][x][y][z] + (1-random1) * parent2_q_table[0][0][x][y][z]
                    child2_q_table[0][0][x][y][z] = random2 * parent1_q_table[0][0][x][y][z] + (1-random2) * parent2_q_table[0][0][x][y][z]
